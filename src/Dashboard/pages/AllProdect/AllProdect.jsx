...
const AllProdect = () => {
    ...
    const onSubmit = async (data) => {
        ...
        // console.log(id)
     axios.put(`http://localhost:5000/updateproduct/${productid}`,postData)
                    ...
                    <tbody>
                        {
                            AllData?.map((datas) => <tr>
                                ...
                                <td className="py-2 px-4 border-b">
                                    <button onClick={onClickTwo(datas._id)} className="text-blue-500">Edit</button>
                            ...
                            <form className='' >
                                                    <div className=' grid md:grid-cols-2'>
                                                        <div className="">
                                                            ...
                                                            <input type="text" className="bg-white px-4 py-2 text-lg outline-none border-2 rounded hover:border-gray-600 border-gray-400 duration-200 bg-inherit" placeholder='Product Type' required />
                                                        </div>
